...
Release operators should also read [`docs/production-readiness.md`](docs/production-readiness.md) and the concrete [`docs/release-v1.0.4.md`](docs/release-v1.0.4.md) handoff.
